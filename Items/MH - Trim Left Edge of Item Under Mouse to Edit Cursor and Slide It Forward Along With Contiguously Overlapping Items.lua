...
-- @author Max Harchik
-- @version 1.0
-- @about Trims the start of any item to the edit cursor and then moves it forward to it's previous start time, keeping the same relative timing to all items that are contiguously connected by overlapping crossfades
